...
# Function to load the LLM and create the RAG chain
# @st.cache_resource allows us to cache the model and chain for performance
@st.cache_resource
def get_rag_chain():
    ...
    # We will create the chain inside the main app logic once the vector store is ready
    return llm
    ...
    if prompt := st.chat_input("Ask a question about your document..."):
        ...
        with st.chat_message("assistant"):
            with st.spinner("Thinking..."):
                # Load the LLM and create the RAG chain
                llm = get_rag_chain()
